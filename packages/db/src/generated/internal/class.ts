...
const config: runtime.GetPrismaClientConfig = {
  "generator": {
    ...
    "output": {
      "value": "/home/vamsi/Projects/WEB DEV/BuildFlow/packages/db/src/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/vamsi/Projects/WEB DEV/BuildFlow/packages/db/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativePath": "../../prisma",
  ...
  "inlineSchemaHash": "e684bdc9d161ccd4842c34df343d13a56bfdc1b0f43dfd368bec6fa440a07c3b",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
...
/**
   ...
   * `prisma.triggers`: Exposes CRUD operations for the **Triggers** model.
    ...
    * ```
    */
  get triggers(): Prisma.TriggersDelegate<ExtArgs, { omit: OmitOpts }>;
  ...
  /**
   * `prisma.availableNodes`: Exposes CRUD operations for the **AvailableNodes** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more AvailableNodes
    * const availableNodes = await prisma.availableNodes.findMany()
    * ```
    */
  get availableNodes(): Prisma.AvailableNodesDelegate<ExtArgs, { omit: OmitOpts }>;
